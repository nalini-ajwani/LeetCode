<h2><a href="https://www.geeksforgeeks.org/problems/union-find/1?page=1&category=Graph&difficulty=Easy&sortBy=submissions">Union-Find</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">This problem is to implement disjoint set union. There will be 2 incomplete functions namely union and find. You have to complete these functions.&nbsp;</span></p>
